  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div
          className={`absolute bg-gradient-to-r w-[40%] p-4 rounded-xl from-primary to-secondary top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center transition-opacity duration-300 ${
        ...
        >
          ...
          <Link href={`/projects/${id}`}>
            <p
              className={`py-3 w-[60%] mx-auto rounded-lg bg-white text-gray-700 font-bold text-lg cursor-pointer ${scale110}`}
            >
              More Info
            </p>
          </Link>
